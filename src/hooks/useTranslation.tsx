...
const en = {
  ...
  "appTitle": "WebP Magic",
  "appDescription": "Transform your JPEG, PNG, and WebP images like magic using your browser.",
  ...
  "errorNoValidFiles": "No image files were found. Please select JPEG, PNG, or WebP files.",
  "errorFileTooLarge": "The file '{fileName}' ({fileSize}) is too large. Please use a file smaller than {maxSize}MB.",
  "errorTooManyFiles": "You can only convert up to {maxFiles} files at once. Please select fewer files.",
  "errorFileValidation": "Some files could not be processed: {errors}",
  "errorCanvasContext": "Unable to process the image. Please try a different file.",
  "errorCreateBlob": "Unable to save the converted image. Please try again.",
  "errorConversionFailed": "Couldn't convert to {targetFormat} format. Please try a different format or browser.",
  "errorLoadImage": "This file appears to be damaged or not a valid image. Please try a different file.",
  "errorCreateZip": "Unable to create the download package. Please try downloading files individually.",
  "errorBrowserSupport": "Your browser is too old for this feature. Please update your browser or try Chrome, Firefox, or Safari.",
  "errorWorkerContext": "Unable to process the image. Please try again or use a different file.",
  "errorWorkerBlob": "Couldn't save the converted image. Please try again.",
  "errorWorkerGeneric": "Something went wrong during conversion. Please try again.",
  "errorCrop": "Unable to crop the image. Please try again or select a different area.",
  "cropOptionsTitle": "Crop (Optional)",
  "enableCropLabel": "Enable Crop",
  "cropPreviewLabel": "Crop Preview",
  "cropInstructionLabel": "Drag on image to select crop area",
  "cropNoImageLabel": "Upload an image to enable cropping",
  "editCropButton": "Edit Crop Area",
  "resetCropButton": "Reset Crop",
  "cropButton": "Crop",
...
const ja = {
  ...
  "removeFile": "ファイルを削除",
  "errorNoValidFiles": "画像ファイルが見つかりませんでした。JPEG、PNG、またはWebPファイルを選択してください。",
  "errorFileTooLarge": "ファイル「{fileName}」({fileSize})が大きすぎます。{maxSize}MB以下のファイルをご利用ください。",
  "errorTooManyFiles": "一度に変換できるのは{maxFiles}個までです。ファイル数を減らしてください。",
  "errorFileValidation": "一部のファイルを処理できませんでした: {errors}",
  "errorCanvasContext": "画像を処理できませんでした。別のファイルをお試しください。",
  "errorCreateBlob": "変換した画像を保存できませんでした。もう一度お試しください。",
  "errorConversionFailed": "{targetFormat}形式への変換ができませんでした。別の形式またはブラウザをお試しください。",
  "errorLoadImage": "このファイルは破損しているか、画像ファイルではありません。別のファイルをお試しください。",
  "errorCreateZip": "ダウンロードパッケージを作成できませんでした。ファイルを個別にダウンロードしてください。",
  "errorBrowserSupport": "お使いのブラウザが古いため、この機能は使用できません。ブラウザを更新するか、Chrome、Firefox、Safariをお試しください。",
  "errorWorkerContext": "画像を処理できませんでした。もう一度お試しいただくか、別のファイルをご利用ください。",
  "errorWorkerBlob": "変換した画像を保存できませんでした。もう一度お試しください。",
  "errorWorkerGeneric": "変換中に問題が発生しました。もう一度お試しください。",
  "errorCrop": "画像を切り抜けませんでした。もう一度お試しいただくか、別の範囲を選択してください。",
  "cropOptionsTitle": "切り抜き (任意)",
  "enableCropLabel": "有効にする",
  "cropPreviewLabel": "切り抜きプレビュー",
  "cropInstructionLabel": "画像上でドラッグして切り抜き範囲を選択",
  "cropNoImageLabel": "画像をアップロードして切り抜きを有効にしてください",
  "editCropButton": "切り抜き範囲を編集",
  "resetCropButton": "切り抜きをリセット",
  "cropButton": "切り抜き",
  "cropModalTitle": "画像の切り抜き",
  "applyCropButton": "切り抜きを適用",
