        ...
        {!isSavingPreset ? (
            <div className="flex gap-2">
             ...
             <div className="flex gap-2 items-center bg-slate-100 dark:bg-slate-900/50 p-2 rounded-md">
                ...
                <button onClick={() => setIsSavingPreset(false)} className="px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 bg-slate-200 hover:bg-slate-300 dark:bg-slate-700 dark:hover:bg-slate-600 rounded-md transition-colors">{t('cancelButton')}</button>
            </div>
        )}
      </div>
